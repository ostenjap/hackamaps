...
const ProfilePublic = () => {
  ...
  const fetchWiecenProfile = async () => {
    setLoading(true);
    
    // Find user with email wiecen@gmail.com
    ...
    setProfile(userData);
    fetchHackathonsWon(userData.user_id);
    fetchHackathonsAttended(userData.user_id);
    setLoading(false);
  };
        ...
        {loading ? (
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>This profile doesn't exist yet</CardDescription>
            </CardHeader>
          </Card>
        ) : (
          <>
              ...
              <CardHeader>
                <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                  <Avatar className="h-32 w-32">
                    ...
                    <AvatarFallback>{profile?.name?.[0] || "W"}</AvatarFallback>
                  </Avatar>

                  <div className="flex-1 text-center md:text-left">
                    <CardTitle className="text-3xl mb-2">{profile?.name || "Wiecen"}</CardTitle>
