        ...
        <div className="flex-1 w-full">
            <div className="min-h-[calc(100vh-80px)] flex flex-col items-center justify-center text-center max-w-3xl mx-auto px-4 -translate-y-12 animate-in fade-in zoom-in duration-500">
                ...
                <p className="text-neutral-400 max-w-lg mx-auto text-base md:text-lg leading-relaxed mb-6 px-2">
                    Discover live hackathons. Find your <strong>CO-FOUNDER</strong> .<br className="hidden md:block" /> Meet <strong>INVESTORS</strong>. Ship code that matters.
                </p>

                <div className="flex flex-col items-center gap-4">
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-3 w-full max-w-md">
                        <Button onClick={() => setView('discover')} className="h-12 w-full sm:w-auto px-8 text-base">
                            Start Exploring <ChevronRight className="ml-2 w-4 h-4" />
                        </Button>
                        <Button variant="outline" onClick={() => setView('map')} className="h-12 w-full sm:w-auto px-8 text-base font-mono">
                            [M] Map View
                        </Button>
                    </div>
